...
- **Placeholder POD:** literal `RO005EXXXXXXXXX` (uppercase, in titles) + `ro005exxxxxxxxx` (lowercase, in entity IDs). Find/replace handles user substitution.
...
- `ha_get_history source=statistics period=day entity_ids=retele_electrice:ro005exxxxxxxxx_import start_time=2025-09-01` → daily rows starting 2025-10-01 forward.
